...
const PrintMessage = async () => {
    ...
    helloworld4_set_output=await helloworld4.set(3333);    
    

    
    await console.log("[hardhat_deploy_contract_shibarium/PrintMessage.js]. helloworld4_set_output: ", helloworld4_set_output);
