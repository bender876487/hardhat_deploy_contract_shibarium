...
const deployhelloworld3_and_createaccount_and_addmodule = async () => {
...
//run deployhelloworld3_and_createaccount_and_addmodule() and catch error
deployhelloworld3_and_createaccount_and_addmodule()
  .then(() => process.exit(0))
  .catch((error) => {
    console.error(error);
    process.exit(1);
