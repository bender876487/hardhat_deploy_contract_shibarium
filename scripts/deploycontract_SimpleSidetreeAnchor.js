...
//PART1. DEPLOY deploycontract_SimpleSidetreeAnchor
//PART2. CREATEACCOUNT
//PART3. ADDMODULE
...
const deploycontract = async () => {
    ...
    // /media/disk5/virtualbox_20211100/karametron/hardhat-tutorial/contracts/deploycontract_SimpleSidetreeAnchor.sol
    const SimpleSidetreeAnchor = await hre.ethers.getContractFactory("SimpleSidetreeAnchor");
    
    //lets deploy the contract
    const SimpleSidetreeAnchordeploy = await SimpleSidetreeAnchor.deploy();

    await SimpleSidetreeAnchordeploy.deployed();

    await console.log("[file scripts/deploycontract_SimpleSidetreeAnchor.js]. /blabla/hardhat-tutorial/contracts/deploycontract_SimpleSidetreeAnchor.sol deployed to:", SimpleSidetreeAnchordeploy.address);
...
new ethers.Wallet(metamask_wallet_privatekey, provider)
    ...
    * /
    ...
    //mnt/workspaceetc/workspace_all/web3/safe/deploycontract_SimpleSidetreeAnchor.zip
    ...
    var addmoduletest = SimpleSidetreeAnchordeploy.address;
